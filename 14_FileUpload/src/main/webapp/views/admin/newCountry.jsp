...
<g>
	...
	<path d="M70.9,26.4c8.6-1,104.7-7.5,113-7.5c4.7,0,13-18.9,3.3-18.9C184.8,0,90,6.7,80.4,7.6
		...
		<div class="form-item">
			<form:input path="name" placeholder="name country" type="text" name="email" id="email" class="form-style" autocomplete="off"/>
		</div>
		
		<div class="form-item">
		
		<input type="submit" class="login pull-right" value="save country">
