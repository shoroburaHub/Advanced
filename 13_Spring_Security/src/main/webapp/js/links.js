var links = [{label: document.getElementById('link1'), bg: '#c0392b'}, 
             {label: document.getElementById('link2'), bg: '#16a085'}, 
             {label: document.getElementById('link3'), bg: '#8e44ad'}, 
             {label: document.getElementById('link4'), bg: '#27ae60'}, 
             {label: document.getElementById('link5'), bg: '#f39c12'}];
...
function addLinks() {
  for (var i=0, l=links.length; i<l; i++) {
    ...
    var newLink = 'link'+(i+1);
    
    link.href = document.getElementById(newLink).getAttribute("href");
    ...
    console.log(links[i].label.attributes);
    
    link.innerHTML =links[i].label.attributes.href.value;
